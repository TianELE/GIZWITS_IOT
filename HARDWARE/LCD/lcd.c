...
#include "image1.h"
#include "image2.h"
#include "image_wifi1.h"
#include "image_wifi2.h"
#include "image_t.h"
#include "image_h.h"
#include "image_als.h"
...
void Display_image1(u16 x, u16 y)
{
    LCD_Show_Image(x, y, 240, 160, gImage_image1);
}
void Display_image2(u16 x, u16 y)
{
    LCD_Show_Image(x, y, 120, 120, gImage_image2);
}
void Display_imagewifi1(u16 x, u16 y)
{
    LCD_Show_Image(x, y, 40, 40, gImage_image_wifi1);
}
void Display_imagewifi2(u16 x, u16 y)
{
    LCD_Show_Image(x, y, 40, 35, gImage_image_wifi2);
}
void Display_image_t(u16 x, u16 y)
{
    LCD_Show_Image(x, y, 10, 16, gImage_image_t);
}
void Display_image_h(u16 x, u16 y)
{
    LCD_Show_Image(x, y, 10, 16, gImage_image_h);
}
void Display_image_als(u16 x, u16 y)
{
    LCD_Show_Image(x, y, 10, 16, gImage_image_als);
}
/**
 * @brief	LCD初始化
 *
