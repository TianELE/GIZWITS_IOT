...
* @{
*/
#define PRODUCT_KEY "75777d5b87504df2819d2cad1023a11c"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "1a704710a0ef426eb765e10ddd50f550"
...
* @{
*/
#define CTRL_BYTEOFFSET                    0
#define CTRL_BITOFFSET                     0
#define CTRL_LEN                           2

#define TEMP_RATIO                         0.1
#define TEMP_ADDITION                      -20
#define TEMP_MIN                           0
#define TEMP_MAX                           1200
#define HUMI_RATIO                         0.001
#define HUMI_ADDITION                      0
#define HUMI_MIN                           0
#define HUMI_MAX                           1000
#define ALS_RATIO                         1
#define ALS_ADDITION                      0
#define ALS_MIN                           0
#define ALS_MAX                           10000
#define TEMP_S_RATIO                         0.1
#define TEMP_S_ADDITION                      -20
#define TEMP_S_MIN                           0
#define TEMP_S_MAX                           1200
#define CO2_RATIO                         1
